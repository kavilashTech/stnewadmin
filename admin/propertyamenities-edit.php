...
if (isset($_POST['update'])) {
    ...
    header('location: propertyamenities.php');
}
                ...
                <div class="card" style="width:60%;">
                    <form method="POST">
                        <div class="card-header" style="font-size:25px; color:grey">
                            <span><strong>Property Amenities - Edit</strong></span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer" style="float:right">
                            <a href="propertyamenities.php"><button type="button" class="btn btn-secondary"><span class="glyphicon glyphicon-remove"></span> Cancel</button></a>
