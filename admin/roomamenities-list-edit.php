...
//TODO : Check mysqli_query alternative style coding
    ...
    header('location: roomamenities-list.php');
}
                ...
                <div class="card" style="width:60%;">
                    <form method="POST">
                        <div class="card-header" style="font-size:25px; color:grey">
                            <span><strong>Room Amenities List - Edit</strong></span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer" style="float:right">
                            <a href="roomamenities-list.php"><button type="button" class="btn btn-secondary"><span class="glyphicon glyphicon-remove"></span> Cancel</button></a>
