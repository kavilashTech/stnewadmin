...
// The room based files will handle only room level amenities with the value level = 0 in amenities table.
            ...
            <div class="container-fluid px-4 mt-5">
                <div class="card" style="width:80%;">
                    <div class="card-header d-flex" style="font-size:25px; color:grey">
                        <span><strong>Amenities - Room Level</strong></span>
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered table-hover table-crud">
                            ...
                            <tbody>
                                <?php
                                // Show only room level amenities
                                $query = mysqli_query($connection, "select * from `amenities` where level=1");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- <td><?php //echo $row['icon']; 
                                                    ?></td> -->
                                        <td>
                                            <a href="roomamenities-edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-status-positive btn-rounded btn-icon" title="Edit"><i class="fas fa-sm fa-edit"></i></a>
                                            <a href="roomamenities-list.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-rounded btn-icon" title="Amenities List"><i class="fas fa-sm fa-list"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="roomamenities-edit.php">
                        <div class="row">
                            <div class="col-lg-4">
